...
namespace Hup234design\Cms\Filament\Forms\Fields;

use Awcodes\Curator\Components\Forms\CuratorPicker;
use Filament\Forms;
use Hup234design\Cms\Filament\Forms\Components\MediablePreview;
    ...
    public static function make(string $relationship, string $type): Forms\Components\Group
    {
        return Forms\Components\Group::make()
            ...
            ->schema([
                ...
                \Hup234design\Cms\Filament\Forms\Components\MediablePreview::make('preview')
