<x-app-layout>
    ...
    <div class="grid gap-24 lg:grid-cols-2 ">
        ...
        <div class="grid gap-8 md:grid-cols-4 lg:grid-cols-2">
            <div class="bg-et-dark-skyblue rounded-3xl flex items-center justify-center text-center shadow-lg shadow-gray-600 p-8">
                <span class="font-bold text-white text-xl">Donate Now</span>
            </div>
            <div class="bg-et-dark-crimson rounded-3xl flex items-center justify-center text-center shadow-lg shadow-gray-600 p-8">
                <span class="font-bold text-white text-xl">Help Us</span>
            </div>
            <div class="bg-et-dark-blue rounded-3xl flex items-center justify-center text-center shadow-lg shadow-gray-600 p-8">
                <span class="font-bold text-white text-xl">Our Projects</span>
            </div>
            <div class="bg-et-dark-skyblue rounded-3xl flex items-center justify-center text-center shadow-lg shadow-gray-600 p-8">
                <span class="font-bold text-white text-xl">Fundraising Ideas</span>
            </div>
        </div>
    </div>
    </div>
